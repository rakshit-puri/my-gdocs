...
const Avatar = ({ src, name }: AvatarProps) => {
	return (
		<div
			className="group -ml-2 flex shrink-0 border-4 place-content-center relative border-white rounded-full bg-gray-400"
		...
		>
			...
			<Image src={src} alt={name} className="size-full rounded-full" width={AVATAR_SIZE} height={AVATAR_SIZE} />
		</div>
	);
};
